...
def render_tab():
    ...
    st.warning(
        "The **sncRNA Counts Viewer** tab is designed specifically for [output files](https://github.com/ktrachtova/perseqpipe/blob/main/docs/outputs.md#sncrna-quantification-output-file-format) generated by the PerSeqPIPE workflow. "
    ...
    # File uploader
    uploaded_file = st.file_uploader("Upload a TSV file (**.short_rna_counts.tsv**)", type=["tsv"], help = "TSV tab-separated file with columns: sequence, expression, pirna, trna, snorna, srna, mrna, lncrna, genome_alignments, MINT_plate. If using PerSeqPIPE locate files with `.short_rna_counts.tsv` suffix in `quantification/` output folder.")
